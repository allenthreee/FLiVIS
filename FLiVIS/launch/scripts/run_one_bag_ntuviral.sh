...
source /home/allen/flivis_ws/devel/setup.bash # TODO: Please change this one based on your env

export EPOC_DIR=/home/allen/flivis_ws;
export DATASET_LOCATION=/home/allen/flvis_dataset/viral/;
export ROS_PKG_DIR=$(pwd);
export EXP_NAME=nya_01;
# export EXP_NAME=$4;
...
export EXP_OUTPUT_DIR=$EPOC_DIR/shengyang_madgwick_beta_0.12/result_${EXP_NAME}_${ANC_MAX}anc;
if ((FUSE_VIS==1))
then
...
roslaunch flivis mapping_NTUviral.launch autorun:=true \
...
& \
timeout $LOG_DUR rostopic echo -p --nostr --noarr /Odometry > $EXP_OUTPUT_DIR/predict_odom_shengyang_madgwick_beta_0.12.csv
# & \
