...
flivis_ikdtree = csvread("./flivis_time_log.csv",1,0);
timestamp_ikd = flivis_ikdtree(:,1);
timestamp_ikd = timestamp_ikd - min(timestamp_ikd);
total_time_ikd = flivis_ikdtree(:,2)*1e3;
scan_num = flivis_ikdtree(:,3);
incremental_time_ikd = flivis_ikdtree(:,4)*1e3;
search_time_ikd = flivis_ikdtree(:,5)*1e3;
delete_size_ikd = flivis_ikdtree(:,6);
delete_time_ikd = flivis_ikdtree(:,7) * 1e3;
tree_size_ikd_st = flivis_ikdtree(:,8);
tree_size_ikd = flivis_ikdtree(:,9);
add_points = flivis_ikdtree(:,10);

flivis_forest = csvread("flivis_time_log.csv",1,0);
fov_check_time_forest = flivis_forest(:,5)*1e3;
average_time_forest = flivis_forest(:,2)*1e3;
total_time_forest = flivis_forest(:,6)*1e3;
incremental_time_forest = flivis_forest(:,3)*1e3;
search_time_forest = flivis_forest(:,4)*1e3;
timestamp_forest = flivis_forest(:,1);
